...
import { ReactComponent as PriorityOneIcon  } from "../icons_FEtask/Img - Low Priority.svg";
import { ReactComponent as PriorityTwoIcon  } from "../icons_FEtask/Img - Medium Priority.svg";
import { ReactComponent as PriorityThreeIcon  } from "../icons_FEtask/Img - High Priority.svg";
    ...
    <div className="cardContainer flex-gap-10" style={{ gap: "5px" }}>
      <div className="cardHeading flex-sb">
        ...
        >
          ...
          <div>
            {["CAM-3", "CAM-9"].includes(id) ? (
              <div className="showStatusYellow"></div>
            ) : id === "CAM-10" ? (
              <div className="showStatusGreen"></div>
            ) : (
        ...
        {tag?.map((element, index) => {
          return (
            <div key={index} className="tags color-grey">
              {" "}
              <span className="dot"><FaCircle/> </span>  { element}
            </div>
          );
        })}
      </div>
